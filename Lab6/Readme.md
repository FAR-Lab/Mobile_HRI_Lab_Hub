...
It is about time to have a functioning mobile robot! Starting from this lab, you should prioritize robot building and/or study design. 
...
If you haven't already, now is a good time to actually mockup the robot for your final project. At least, you should have a chassis that safely host all the hardware you have (ODrive, wheels, battery, etc).
...
Based on your scenario, sketch out a sequence of movement.
